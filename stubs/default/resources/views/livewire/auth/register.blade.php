        ...
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            <form wire:submit.prevent="register">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="username" id="username" type="text" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('username') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:ring-red @enderror" />
                    </div>
...
{{--            <p class="text-xs text-gray-600 mt-3 flex justify-center">- or continue with -</p>--}}

{{--            <div class="flex justify-between items-center pt-3">--}}
{{--                <a href="{{ route('social.oauth', 'facebook') }}" class="w-full flex justify-center items-center text-white bg-blue-900 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-sm mr-1">--}}
{{--                    <i class="fa fa-facebook fa-fw"></i> Facebook</a>--}}
{{--                <a href="{{ route('social.oauth', 'twitter') }}" class="w-full flex justify-center items-center text-white bg-blue-400 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-sm ml-1">--}}
{{--                    <i class="fa fa-twitter fa-fw"></i> Twitter</a>--}}
{{--                <a href="{{route('social.oauth', 'google') }}" class="w-full flex justify-center items-center text-white bg-red-600 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-sm ml-1">--}}
