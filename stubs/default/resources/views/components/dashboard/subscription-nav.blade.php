        ...
        <nav class="flex h-14 items-center space-x-4">
            ...
            <div class="flex h-full items-center space-x-4 ">
                ...
                @if(auth()->user()->subscribed())
                    ...
                    <a href="{{ route('account.subscriptions.swap') }}"
                    ...
                    <a href="{{ route('account.subscriptions.card') }}"
                    ...
                    <a href="{{ route('account.subscriptions.coupon') }}"
                    ...
                    @can('cancel', auth()->user()->subscription())
                        <a href="{{ route('account.subscriptions.cancel') }}"
                    ...
                    @can('resume', auth()->user()->subscription())
                        <a href="{{ route('account.subscriptions.resume') }}"
